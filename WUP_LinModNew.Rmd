...
summary.lm(model.1)
```
Here we see the Residual standard error at 1.295 and the adjusted r-squared at 0.4053. In this instantce SIMS~ARM would rank first between the two variables.
